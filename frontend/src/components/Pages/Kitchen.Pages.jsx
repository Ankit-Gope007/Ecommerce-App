    ...
    useEffect(() => {
        try {
            const fetchProducts = async () => {
                const response = await axios.get(`https://ecommerce-app-backend-kyd3.onrender.com/api/products/getProductsByCategory/Kitchen Utensils`)
